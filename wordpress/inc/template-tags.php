...
/*
 * Custom ajax functions to handle stuff from front end 
 * likes on open data
 */
 if ( !function_exists('update_open_data_meta') ){
                   
                    function update_open_data_meta(){

                        //check_ajax_referer('ajax_post_validation', 'security');
                        wp_verify_nonce( $_POST['security'], 'ajax_post_validation' );

                       $post_id = $_POST['post_id'];

                        $meta = $_POST['meta'];

                        // get previopusvalue from DB itself
                    ...
                    add_action( 'wp_ajax_nopriv_update_open_data_meta', 'update_open_data_meta' );
